...
require_once ZJPP_PLUGIN_DIR . '/includes/lib/ecpay/includes/helpers/ECPayPaymentModuleHelper.php';
require_once ZJPP_PLUGIN_DIR . '/includes/lib/ecpay/includes/ECPay.Payment.Integration.php';

class ECPayPaymentHelper extends \ZJPP\ECPayPaymentModuleHelper
{
    use singleton;
    /**
     ...
     * @var string SDK class name(required)
     */
    protected $sdkClassName = 'ZJPP\\ECPay_Woo_AllInOne';
    ...
    private function checkoutPrepare($data)
    {
        ...
        $this->sdk->Send['OrderResultURL'] = $inputs['orderResultURL'];
